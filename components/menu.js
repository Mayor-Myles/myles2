...
import { FaExchangeAlt,FaLaptop} from 'react-icons/fa';
    ...
    <>
      <ChakraProvider>
        {loadingPage ? (
          ...
          <Box bg={currentMode == "dark" && "black"}  mt={6}>
            <Box boxShadow="sm" borderRadius="lg" maxW={{base:"md",md:"100%","lg":"100%","xl":"100%"}} mx="2em" p={2}>
